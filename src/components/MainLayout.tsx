        ...
        <div className="w-full md:w-[35%] md:fixed md:left-0 md:top-16 md:h-[calc(100vh-4rem)] p-8 flex flex-col items-center md:items-start">
          <div className="flex flex-col h-full items-center md:items-start">
            <div className="text-center md:text-left mb-2">
              ...
              <p
                className="text-gray-700 uppercase font-raleway mb-6"
                style={{
                  fontFamily: "Raleway, Helvetica, sans-serif",
                  fontSize: "0.7em",
                  fontWeight: 400,
              ...
              >
                I&apos;m a software developer with knowledge of Next.js,
                React.js, and React Native, specializing in creating responsive
                web applications. I have also built 2 native apps which are
            ...
            <div className="mt-2 mb-8">
              <div className="flex justify-center md:justify-start space-x-6">
                ...
                <a
                  href="https://www.instagram.com/i_am_kapildj?igsh=MWc0dnIzZjZwNHl4MA=="
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-600 hover:text-blue-600"
                >
                ...
                <a
                  href="https://www.hackerrank.com/profile/kapiljadhav5656"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-600 hover:text-blue-600"
                >
